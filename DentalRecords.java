...
public class DentalRecords {
    ...
    private void getFamilyInfo() {
        ...
        for (int person = 0; person < numberOfPeople; person++) {
            ...
            teeth[person][0] = getTeethInput("uppers", person);

            teeth[person][1] = getTeethInput("lowers", person);
        }


    } // end of getFamilyInfo method

    private char[] getTeethInput (String layer,int person){
        String teethInput;
        char[] teethArray;
    ...
    private void extractTooth() {
        ...
        int personIndex = findFamilyMemberIndex(memberName);

        while (personIndex == -1) {
            System.out.print("Invalid family member, try again: ");
            memberName = scanner.next();
            personIndex = findFamilyMemberIndex(memberName);
        }
    ...
    private int findFamilyMemberIndex(String memberName) {
    ...
    private void getFamilyRootCanal() {
    ...
    } // end of getFamilyRootCanal method
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            switch (menuOption) {
                case 'P':
                    records.printFamilyInfo();
                    break;
                case 'E':
                    records.extractTooth();
                    break;
                case 'R':
                    records.getFamilyRootCanal();
                    break;
                case 'X':
